...
function slider({
  ...
  ;
  const postZero = function (slider, curr) {
    if (slider.length < 10) {
      return curr.textContent = `0${slideIndex}`;
    } else {
      return curr.textContent = slideIndex;
    }
  };
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-11-26');
